...
zip -r chest_pretext_4096.zip MoCo_train_checkpoints
zip -r chest_dowstr_4096.zip MoCo_eval_checkpoints
cd
./gdrive upload SSL_MoCo_New/chest_dowstr_4096.zip
./gdrive upload SSL_MoCo_New/chest_pretext_4096.zip
