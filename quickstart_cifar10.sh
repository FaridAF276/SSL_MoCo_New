...
zip -r cifar10_2048_pretext.zip MoCo_train_checkpoints
cd 
./gdrive upload SSL_MoCo_New/cifar10_2048_pretext.zip
cd SSL_MoCo_New
...
zip -r cifar10_2048_dowstr.zip MoCo_eval_checkpoints
cd
./gdrive upload SSL_MoCo_New/cifar10_2048_dowstr.zip