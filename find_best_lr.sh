...
set -e 
'''
apt-get install -y git zip vim unzip fastjar && git clone https://github.com/FaridAF276/SSL_MoCo_New.git && \
...
cd SSL_MoCo_New && chmod +x find_best_lr.sh && ./find_best_lr.sh
'''
apt update -y
